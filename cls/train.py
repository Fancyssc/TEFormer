...
# IMPORT your models
# CIFAR
from models.baseline import(spikf_bl_seq, spikf_bl_cifar, sdt_bl_seq, sdt_bl_cifar,
                            qk_bl_seq, qk_bl_cifar, TIMv1_bl_cifar)

from models.TIMv2 import (TIMv2_e3_cifar, TIMv2_e3_seq)
