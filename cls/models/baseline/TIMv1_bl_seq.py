...
class SPS(BaseModule):
    ...
    def __init__(self, step=4, img_h=32, img_w=32, patch_size=4, in_channels=3, embed_dims=384, **kwargs):
        ...
        self.maxpool = torch.nn.MaxPool1d(kernel_size=3, stride=2, padding=1, dilation=1, ceil_mode=False)
        ...
        self.maxpool1 = torch.nn.MaxPool1d(kernel_size=3, stride=2, padding=1, dilation=1, ceil_mode=False)
        ...
        self.maxpool2 = nn.MaxPool1d(kernel_size=3, stride=2, padding=1, dilation=1, ceil_mode=False)
        ...
        self.maxpool3 = nn.MaxPool1d(kernel_size=3, stride=2, padding=1, dilation=1, ceil_mode=False)
...
class TIMv1(BaseModule):
    def __init__(self, step = 4, in_channels=44, TIM_alpha=0.5):
...
class SSA(BaseModule):
    def __init__(self,embed_dim, step=4, num_heads=12,attn_scale=0.125):
        ...
        self.TIMv1 = TIMv1(step=4, in_channels=44)
...
class Spikformer(BaseModule):
    ...
    def forward(self, x):
        ...
        x = (x.unsqueeze(2)).transpose(0, 1).flatten(0, 1) # TB C N
...
@register_model
def TIMv2_bl_TIMv1_seq(pretrained=False,**kwargs):
    model = Spikformer(
