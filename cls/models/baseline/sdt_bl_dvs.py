...
class SPS(BaseModule):
    def __init__(self, step=4, img_h=32, img_w=32, patch_size=4, in_channels=3, embed_dims=256,**kwargs):
...
class SDT_Block_s(nn.Module):
    def __init__(self, embed_dim=256, num_heads=16, step=4, mlp_ratio=4.,mlp_drop=0., ):
        super().__init__()
...
@register_model
def TIMv2_bl_sdt_dvs(pretrained=False,**kwargs):
    model = SDTV1(
