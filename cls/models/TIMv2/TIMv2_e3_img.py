...
class TIMv2(BaseModule):
    def __init__(self, step = 4):
        ...
        # self.theta = nn.Parameter(theta_init.unsqueeze(0))  # shape: (1,)
...
class TokenSpikingTransformer(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp = T_MLP(in_features= dim, step=4,mlp_ratio=mlp_ratio)
        # self.mlp = MLP(in_features= dim, step=4)
...
@register_model
def TIMv2_e3_img(pretrained=False,**kwargs):
