...
#ImgNet
from models.baseline import  qk_bl_img, qk_bl_cifar
from models.baseline import sdt_bl_img
from models.baseline import spikf_bl_img

from models.TIMv2 import TIMv2_e3_img
        ...
        if args.experiment:
            ...
            exp_name = "--".join(
                [
                    ...
                    safe_model_name(args.model),
                    str(args.dataset).split("/")[-1],  # 防止创建奇怪的路径
                    str(args.depths)+'-'+ str(args.embed_dim),
                    # args.node_type,
